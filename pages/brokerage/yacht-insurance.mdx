...
export const meta = {
  ...
  description: `WealthGuard offers insurance products to accommodate a wide variety of marine risks, including coverage for boats, yachts, high performance, and tradesman vessels. Policies include customizable options to meet specific coverage needs.`,
