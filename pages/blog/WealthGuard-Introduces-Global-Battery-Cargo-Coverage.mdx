...
export const meta = {
  ...
  heroDescription: `(MAGNOLIA, TX) — WealthGuard Insurance Group LLC is selected as provider of new Lloyds-backed lithium battery cargo coverage.`,
  ...
  category: `News`,
  tags: [`Brokerage`, `Products`, `Battery Cargo`, 'Cargo & Logistics', 'Stock Throughput', 'Lloyds', 'Lithium Battery'],
}
