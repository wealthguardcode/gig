    ...
    <Layout>
      ...
      <div className='py-24 bg-gray-50 dark:bg-gray-800 sm:py-32'>
        <div className='max-w-md mx-auto pl-4 pr-8 sm:max-w-lg sm:px-6 lg:max-w-7xl lg:px-8'>
          ...
          <p className='mt-6 max-w-3xl mx-auto prose md:prose-lg leading-normal text-gray-500 dark:text-gray-400'>
            <strong className='text-gray-500 dark:text-gray-400'>
              WealthGuard Insurance Group
            </strong>{' '}
            operates the goguardig.com website, which provides the SERVICE.
          </p>

          <p className='py-2 max-w-3xl mx-auto  prose md:prose-lg leading-normal text-gray-500 dark:text-gray-400'>
            This page is used to inform website visitors regarding our policies
            with the collection, use, and disclosure of Personal Information if
            anyone decided to use our Service, the GoGuard website.
          </p>
          ...
          <p className='py-2 max-w-3xl mx-auto  prose md:prose-lg leading-normal text-gray-500 dark:text-gray-400'>
            ...
            our Terms and Conditions, which is accessible at goguardig.com,
          ...
          <p className='pb-2 max-w-3xl mx-auto  prose md:prose-lg leading-normal text-gray-500 dark:text-gray-400'>
            ...
            the website that you visit and are stored on your computer&apos;s
            hard drive.
          </p>
          ...
          <ul className='py-2 max-w-3xl mx-auto  prose md:prose-lg leading-normal text-gray-500 dark:text-gray-400 list-disc'>
            <li className='ml-9'>To facilitate our Service;</li>
            <li className='ml-9'>To provide the Service on our behalf;</li>
            <li className='ml-9'>To perform Service-related services; or</li>
            <li className='ml-9'>
          ...
          <p className='pt-2 max-w-3xl mx-auto text-lg md:text-xl font-bold leading-normal text-gray-500 dark:text-gray-400'>
            Children&apos;s Privacy
          </p>
