      ...
      <div className="relative bg-blue-400">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          ...
          {/* <p className="mt-6 text-xl text-blue-100 max-w-3xl">
            ...
            ornare eleifend justo, hendrerit venenatis ligula posuere sed. Duis
            ac odio eget turpis accumsan dignissim quis sollicitudin diam. Sed
            dictum nibh vitae hendrerit imperdiet. Aenean tincidunt sed est at
            hendrerit.
          </p> */}
        </div>
      </div>
