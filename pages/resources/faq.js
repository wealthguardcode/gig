    ...
    <Layout title="WIG | Faq's">
      <div className='relative bg-gray-400'>
        ...
        <div className='relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8'>
          ...
          <p className='mt-6 text-2xl text-red-100 max-w-3xl'>
      ...
      <div className='bg-white dark:bg-gray-800 py-16 lg:py-24'>
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='relative py-24 px-8 bg-red-700 rounded-xl shadow-2xl overflow-hidden lg:px-16 lg:grid lg:grid-cols-2 lg:gap-x-8'>
