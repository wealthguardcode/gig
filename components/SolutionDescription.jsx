export default function SolutionDescription({ subHeading, description }) {
  return (
    <div className='flex flex-col my-6'>
      <div className='text-base max-w-prose md:max-w-md lg:max-w-none'>
      ...
      <div className='relative z-10 prose md:max-w-md sm:mx-4 md:mx-2 lg:max-w-xl lg:mx-0 mb-10 mx-4'>
