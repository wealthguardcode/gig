      ...
      <div className='max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:flex lg:justify-between lg:items-center lg:py-24 lg:px-8'>
        ...
        <div className='flex mt-8 lg:shrink-0 lg:mt-0'>
          <div className='inline-flex rounded-md shadow'>
            <Link
              href='/contact-us'
              className='inline-flex justify-center items-center py-3 px-5 border border-transparent rounded-md text-base font-medium text-white bg-gray-600 hover:text-gray-300 hover:bg-gray-700 dark:bg-gray-400 dark:hover:bg-gray-500'>
              <>
                <span>Contact us</span>
                <EnvelopeIcon
                  aria-hidden='true'
                  className='shrink-0 h-5 w-5 ml-3 text-gray-50'
                />
              </>
            </Link>
          </div>
